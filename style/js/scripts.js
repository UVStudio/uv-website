...
$(document).ready(function () {
    ...
    // THE HANDLING IN CASE ITEM IS CLICKED
      ...
      item.click(function () {
        ...
        if (jQuery('.dark-wrapper.fixed').length == 0) {
          ...
          jQuery('.body-wrapper').wrapInner(
            '<div class="fullcontent-slider-getaway-wrapper"><div class="fullcontent-slider-getaway-slide"></div></div>'
          );
          ...
          jQuery('body').append(
            '<div class="navcoverpage light-wrapper"></div>' +
          ...
          jQuery('body')
            .append(
              '<div class="preparedtostart right fullcontent-content-wrapper-new ' +
                extraclass +
                ' ' +
                animclass +
                '"></div>'
          ...
          setTimeout(function () {
            if (conurl != undefined && conurl.length > 0) {
              jQuery('.fullcontent-content-wrapper-new').load(
                conurl + ' ' + concon,
                function () {
                  jQuery('.preparedtostart.fullcontent-content-wrapper-new')
                    .find('.footer-wrapper')
                    .remove();
                  jQuery('.navfake h1')
                    .html(
                      jQuery('.fullcontent-content-wrapper-new .title').html()
                    )
                    .removeClass('novisibility');
                  animateContents(
                    mainContOut,
                    jQuery('.fullcontent-slider-getaway-slide'),
                    jQuery('.preparedtostart.fullcontent-content-wrapper-new'),
                    speed
                  );
              ...
              jQuery('.fullcontent-content-wrapper-new').append(
                jQuery(this).data('content')
              );
            }
          }, speed + 200);
          ...
          jQuery(document).on('click', '#gwi-thumbs', function () {
            ...
            jQuery('.clicked-no-slide-anim').removeClass(
              'clicked-no-slide-anim'
            );
  ...
  items.slice(0, items.length).each(function (i) {
    ...
    if (
      deeplink != undefined &&
      deeplink.length > 0 &&
      deeplink == jQuery(this).data('contenturl')
    ) {
      if (firstfound == 0) {
        setTimeout(function () {
          item.click();
  ...
  function swapContents(nextitem, dir, animclass, speed) {
    ...
    try {
      ...
      if (jQuery('.preparedtostart').length == 0) {
        jQuery('body').append(
          '<div class="preparedtostart ' +
            pos +
            ' ' +
            extraclass +
            ' ' +
            animclass +
            ' fullcontent-content-wrapper-new"></div>'
        );
      }

      jQuery('.preparedtostart.fullcontent-content-wrapper-new').load(
        conurl + ' ' + concon,
        function () {
          jQuery('body,html').animate(
            {
          ...
          jQuery('body')
            .find('.preparedtostart.fullcontent-content-wrapper-new')
            .each(function (i) {
          ...
          callback();
          jQuery('.preparedtostart.fullcontent-content-wrapper-new')
            .removeClass('preparedtostart')
            .addClass('preparedtoleave');
        }
      );
    } catch (e) {}
  }
...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    $('.onepage .navbar ul.navbar-nav a[href*=#]:not([href=#])').each(
      function () {
        ...
        if (scrollPosition >= thisPosition) {
          ...
          $('.onepage .navbar ul.navbar-nav a[href=' + thisHref + ']')
            .parent('li')
            .addClass('current');
        }
      }
...
var widgetFeed = new Instafeed({
  ...
  template:
    '<li><span class="icon-overlay"><a href="{{link}}" target="_blank"><img src="{{image}}" /></a></span></li>',
  after: function () {
...
/*-----------------------------------------------------------------------------------*/
jQuery(document).ready(function ($) {
  jQuery('a.js-activated')
    .not('a.js-activated[href^="#"]')
    .click(function () {
